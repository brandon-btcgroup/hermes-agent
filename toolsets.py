...
TOOLSETS = {
    ...
    "hermes-simplex": {
        "description": "SimpleX bot toolset - privacy-focused, decentralized messaging via simplex-chat (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
