...
class SimplexAdapter(BasePlatformAdapter):
    ...
    async def _fetch_file(
        ...
        *,
        ...
        container filesystem (``fileSource.filePath``). When
        ``SIMPLEX_FILE_DIR`` is set, we translate it to the host-side path
        via the bind-mount mapping and return early — no sleep needed.
        """
