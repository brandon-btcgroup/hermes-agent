...
```bash
cp plugins/platforms/simplex/templates/container.example   ~/.config/containers/systemd/simplex-chat-hermes.container
cp plugins/platforms/simplex/templates/env.example         ~/.config/containers/systemd/simplex-chat-hermes.env
